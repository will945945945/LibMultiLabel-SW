    ...
    do 
        ...
        do
            ...
            python3 tree_build.py \
                ...
                --modelpath models/tree_K${K}_${data}_${seed}_l1_c${C}.pkl\
                --liblinear_options "-s 3 -c ${C} -B 1 -q"\
            ...
            python3 tree_build.py \
                --datapath datasets/${data}.pkl \
                --modelpath models/tree_K${K}_${data}_${seed}_l2_c${C}.pkl\
                --liblinear_options "-s 1 -c ${C} -B 1 -q"\
                --treepath "treestructures/tree_structure_K${K}_${data}_${seed}.pkl"\
                --K ${K} \
                --seed ${seed} \
                #--buildtree 1
            ...
            python3 tree_build.py \
                --datapath datasets/${data}.pkl \
                --modelpath models/tree_K${K}_${data}_${seed}_lr_c${C}.pkl\
